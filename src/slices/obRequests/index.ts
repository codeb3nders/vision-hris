...
import { URL_OB_REQUESTS as URL } from 'constants/EndpointPath';
...
export const OBRequestsSlice = createSlice({
  name,
  initialState: {
    ...initialCreateState,
    ...initialUpdateState,
...
export const { reset } = OBRequestsSlice.actions;

export default OBRequestsSlice.reducer;
