...
import { URL_OT_REQUESTS as URL } from "constants/EndpointPath";
...
export const OTRequestsSlice = createSlice({
  name,
  initialState: {
    ...initialCreateState,
    ...initialUpdateState,
...
export const { reset } = OTRequestsSlice.actions;

export default OTRequestsSlice.reducer;
