...
const Main = ({children}) => {
		...
		<React.Fragment>
			...
			<Collapse in={isFormsOpen} timeout="auto" unmountOnExit>
				<List component="div" disablePadding>
					<ListItemButton sx={{pl: 4}} onClick={() => setCurrentPage("leave-list")}>
						<ListItemIcon>
							<TimeToLeaveOutlined />
						</ListItemIcon>
					...
					<ListItemButton sx={{pl: 4}} onClick={() => setCurrentPage("ot-list")}>
						<ListItemIcon>
							<MoreTimeOutlined />
						</ListItemIcon>
			...
			<Collapse in={isManageOpen} timeout="auto" unmountOnExit>
				<List component="div" disablePadding>
					<ListItemButton sx={{pl: 4}} onClick={() => setCurrentPage("leave-manage")}>
						<ListItemIcon>
							<TimeToLeaveOutlined />
						</ListItemIcon>
						<ListItemText secondary="Leave Management" />
					</ListItemButton>
					<ListItemButton sx={{pl: 4}} onClick={() => setCurrentPage("ot-manage")}>
						<ListItemIcon>
							<MoreTimeOutlined />
						</ListItemIcon>
			...
			<ListItemButton onClick={() => setCurrentPage("workers")}>
				<ListItemIcon>
					<Group />
				</ListItemIcon>
				<ListItemText secondary="Workers Database" />
			</ListItemButton>
			...
			<ListItemButton>
				...
				<ListItemText secondary="Personal Information" />
			</ListItemButton>
		</React.Fragment>
	)
	...
	return (
		<ThemeProvider theme={mdTheme}>
			<Box sx={{display: "flex"}}>
				<CssBaseline />
				<AppBar position="absolute" open={open} sx={{backgroundColor: VISION_RED}}>
					<Toolbar
						sx={{
				...
				>
					...
					<Container maxWidth="lg" sx={{mt: 4, mb: 4}}>
						<Grid container spacing={3} flexDirection="column" justifyContent="center">
							{children}
						</Grid>
					</Container>
				</Box>
