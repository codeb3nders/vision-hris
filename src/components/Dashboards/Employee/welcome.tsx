...
export const WelcomeCtx = createContext<{ index: number }>({ index: 0 });
  ...
  return (
    <WelcomeCtx.Provider value={{ index }}>
      ...
      >
        ...
        {index === 1 && (
          <button className='tablet:block laptop:block desktop:block absolute flex items-center phone:hidden  right-[14px] top-[14px] col-span-1 justify-self-end bg-white text-v-red py-1 px-2 rounded-md text-xs'>
