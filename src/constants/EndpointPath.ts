...
export const URL_EMPLOYEES_WITH_LEAVES = `${env.BASE_URL}/employees/leaves/`;
export const URL_EMPLOYEES = `${env.BASE_URL}/employees/`;
export const URL_LOGIN = `${env.BASE_URL}/login/`;
...
export const URL_ASSETS = `${env.BASE_URL}/asset/management/`;
export const URL_DISCIPLINARY_CASES = `${env.BASE_URL}/disciplinary-actions/`;
export const URL_EMPLOYEE_DOCUMENTS = `${env.BASE_URL}/employee-documents/`;
export const URL_EMPLOYEE_SEARCH = `${env.BASE_URL}/employees/search?`;
export const URL_FORGOT_PASSWORD = `${env.BASE_URL}/user-credentials/forgot-password/`;
